...
import net.kunmc.lab.kpm.task.tasks.alias.source.download.signals.SourceDownloadFailedSignal;
import net.kunmc.lab.kpm.task.tasks.alias.source.download.signals.UnsupportedProtocolSignal;
