...
import net.kunmc.lab.teamkunpluginmanager.resolver.impl.CurseBukkitSuccessResult;
import net.kunmc.lab.teamkunpluginmanager.resolver.impl.GitHubSuccessResult;
import net.kunmc.lab.teamkunpluginmanager.resolver.impl.SpigotMCSuccessResult;
