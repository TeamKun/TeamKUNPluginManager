...
public class PluginResolveResult extends PhaseResult<PluginResolveState>
{
    @Getter
    @Nullable
    private final SuccessResult resolveResult;

    public PluginResolveResult(boolean success, @NotNull PluginResolveState phase, @NotNull FailedReason errorCause, @Nullable SuccessResult resolveResult)
    {
