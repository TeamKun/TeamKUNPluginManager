...
import net.kunmc.lab.teamkunpluginmanager.plugin.installer.task.tasks.garbage.clean.GarbageCleanArgument;
import net.kunmc.lab.teamkunpluginmanager.plugin.installer.task.tasks.garbage.clean.GarbageCleanResult;
import net.kunmc.lab.teamkunpluginmanager.plugin.installer.task.tasks.garbage.clean.GarbageCleanTask;
import net.kunmc.lab.teamkunpluginmanager.plugin.installer.task.tasks.garbage.search.GarbageSearchArgument;
import net.kunmc.lab.teamkunpluginmanager.plugin.installer.task.tasks.garbage.search.GarbageSearchTask;
...
public class GarbageCleaner extends AbstractInstaller<CleanArgument, CleanErrorCause, CleanTasks>
{
    ...
    public InstallResult<CleanTasks> execute(@NotNull CleanArgument argument) throws TaskFailedException
    {
        ...
        excludeDataNames.addAll(TeamKunPluginManager.getPlugin().getPluginConfig().getStringList("ignore"));
