...
import net.kunmc.lab.teamkunpluginmanager.installer.task.tasks.dependencies.collector.DependsCollectErrorCause;
import net.kunmc.lab.teamkunpluginmanager.installer.task.tasks.description.DescriptionLoadErrorCause;
