...
import net.kunmc.lab.teamkunpluginmanager.installer.impls.autoremove.signals.PluginUninstallFailedSignal;
import net.kunmc.lab.teamkunpluginmanager.installer.impls.uninstall.PluginUninstallSucceedResult;
